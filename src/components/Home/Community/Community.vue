...
-->
                    <el-button type="primary" @click="showAdd=true"  v-if="hasPrivileges('group_manage')">合并社区</el-button>
                    <el-button style="visibility:hidden">占位</el-button>
                    <el-button type="success" style="float:right" @click="exportExcel('group')">导出表格</el-button>
                    <el-button type="default" style="float:right" @click="showCreate=true"  v-if="hasPrivileges('group_add')">创建社区</el-button>
...
<!--                                    <a href="javascript:void(0)">查看</a>-->
                ...
                <el-dialog title="合并社区" v-model="showAdd">
				  ...
				  <span slot="footer" class="dialog-footer">
           		...
           		<el-dialog title="创建社区" v-model="showCreate">
				  <el-form :model="create">
					  ...
					  <el-input type="textarea" :row="2" v-model="create.introduce" auto-complete="off"></el-input>
					</el-form-item>
				  ...
				  <span slot="footer" class="dialog-footer">
           		...
           		<el-dialog title="编辑社区" v-model="showEdit">
				  <el-form :model="edit">
				  	<el-form-item label="社区名称" :label-width="'80px'">
					  <el-input v-model="edit.name" auto-complete="off"></el-input>
					</el-form-item>
<!--
				  	<el-form-item label="社区头像" :label-width="'80px'">
					   <my-unload mId="editC" :onSuccess="successUnload" :action="action" :onDelete="deleteUnload" :img="editImg"></my-unload>
					</el-form-item>
-->
				  	<el-form-item label="社区介绍" :label-width="'80px'">
