        ...
        <el-tabs v-model="activeName">
            ...
            <el-tab-pane label="全部公告" name="全部公告">
                ...
                <div class="table_handle">
                    ...
                    <el-button type="success" style="float:right" @click="exportExcel('announcement')">导出表格</el-button>
                </div>
                ...
                <el-card class="dynamics_show" v-show="showDetail">
                    ...
                    <div class="dynamics_user">
                        ...
                        <span class="username">
                            <span v-if="announceDetail.publisher">{{announceDetail.publisher.name}}</span>
                        </span>
                        <div class="userhead_box">
                            <div v-if="announceDetail.publisher" class="userhead_img" :style="{backgroundImage: 'url('+ announceDetail.publisher.headPic +')',backgroundSize:'cover'}"></div>
                        </div>
                    </div>
                    ...
                    <div class="dynamics_label">
                        ...
                        <span class="label_text">
                            <span v-if="announceDetail.expiredTime">{{announceDetail.expiredTime}}</span>
                        </span>
                    </div>
                    <div class="dynamics_label">
                        ...
                        <div class="dynamics_imgs">
                            ...
                            <div class="dynamics_imgBox">
                                <div v-if="announceDetail.photo">
                                    <div class="show_imgs" v-for="(item,index) in announceDetail.photo" :style="{backgroundImage: 'url('+ item +')',backgroundSize:'cover',backgroundPosition:'center'}"></div>
                                </div>
                            </div>
                            <div class="clear"></div>
                        </div>
                    ...
                    <div class="dynamics_num">
                        <span class="praise_text">点赞数量<span class="praise_num">{{announceDetail.likedNum}}</span></span>
                        <span class="comment_text">评论数量<span class="comment_num">{{announceDetail.commentNum}}</span></span>
                    </div>
                </el-card>
                ...
                <el-dialog title="提示" v-model="showEdit">
                    <el-form :model="issue">
                        <el-form-item class="edit_label" label="内容" :label-width="formLabelWidth">
                            <el-input v-model="edit.content" type="textarea" auto-complete="off" :rows="4"></el-input>
                        </el-form-item>
                        <el-form-item class="edit_label" label="图片" :label-width="formLabelWidth">
                            <my-unload mId="editAnnounce" :onSuccess="successEditUnload" :action="action" :onDelete="deleteEditUnload" :img="edit.img"></my-unload>
                        </el-form-item>
                        <el-form-item class="edit_label" label="URL" :label-width="formLabelWidth">
                            <el-input v-model="edit.url"></el-input>
                        </el-form-item>
                        <el-form-item class="edit_label" label="全商圈" :label-width="formLabelWidth">
                            <el-switch
							  v-model="edit.all"
							  on-text=""
							  off-text="">
                        ...
                        <el-form-item class="edit_label" label="商圈" :label-width="formLabelWidth" v-show="edit.all==false">
                        ...
                        <el-form-item class="edit_label" label="排序" :label-width="formLabelWidth">
                            <el-input-number v-model="edit.sort" :min="1" :max="1000"></el-input-number>
                        </el-form-item>
                        <el-form-item class="edit_label" label="时间" :label-width="formLabelWidth">
                            <el-date-picker
                                v-model="edit.time"
                                type="datetimerange"
                                placeholder="选择时间范围"
            ...
            <el-tab-pane label="创建公告" name="创建公告" v-if="hasPrivileges('announce_add')">
                <div class="block">
                    ...
                    <div class="list_box">
                        ...
                        <div class="img_list">
                            <my-unload mId="issueAnnounce" :onSuccess="successUnload" :action="action" :onDelete="deleteUnload" :img="issue.img"></my-unload>
                        </div>
                    </div>
                    <div class="list_box">
                        <div class="issue_list">URL</div>
